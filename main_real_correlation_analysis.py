...
def compute_ari_cvi_correlations_per_dataset(datasets, metrics, labels_folder):
    ...
    for dataset_name, (X, labels_gt) in datasets:
        ...
        save_correlation_matrix(df_ari,     file_name="realdata3_INTERMEDIATE_correlations_cvi_to_ari")
        save_correlation_matrix(df_ari_nn,  file_name="realdata3_INTERMEDIATE_correlations_cvi_to_ari_nn")
        save_correlation_matrix(df_bari,    file_name="realdata3_INTERMEDIATE_correlations_cvi_to_bari")
        save_correlation_matrix(df_bari_nn, file_name="realdata3_INTERMEDIATE_correlations_cvi_to_bari_nn")
...
if __name__ == "__main__":
    ...
    # Save results
    save_correlation_matrix(correlation_matrices['ari'],        file_name="realdata3_correlations_cvi_to_ari")
    save_correlation_matrix(correlation_matrices['ari_nn'],     file_name="realdata3_correlations_cvi_to_ari_nn")
    save_correlation_matrix(correlation_matrices['bari'],       file_name="realdata3_correlations_cvi_to_bari")
    save_correlation_matrix(correlation_matrices['bari_nn'],    file_name="realdata3_correlations_cvi_to_bari_nn")
