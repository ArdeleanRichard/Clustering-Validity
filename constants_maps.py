...
from ours.mst3 import mst_silhouette_score, mst_davies_bouldin_score, mst_calinski_harabasz_score
...
MAP_METRIC_TO_FUNCTION = {
    ...
    # "MST2-CH": mst_calinski_harabasz_score,

    "MST3-S": mst_silhouette_score,
    "MST3-DB": mst_davies_bouldin_score,
    "MST3-CH": mst_calinski_harabasz_score,
    # "idea": mst_idea,
}
