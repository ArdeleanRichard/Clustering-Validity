...
def save_results(results_by_dataset, results_by_algo, file_prefix):
    ...
    df_by_dataset_pivot = df_by_dataset.pivot(index='metric', columns='dataset', values=['correct', 'errors'])
...
def main(data_type):
    ...
    if data_type == "synth_data":
        ...
        plot_folder = FOLDER_RESULTS_CORRELATION + f"{data_type}_error_plots/"
    ...
    save_results(results_by_dataset, results_by_algo, data_type)
